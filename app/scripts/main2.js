...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function showNotification() {
    ...
    setTimeout(function() {
      ...
      }, 500); // Retraso antes de eliminar la notificación para permitir la animación de desvanecimiento
    }, 5000); // Duración de la notificación: 5000 milisegundos

    const closeNotificationButton = notificationDiv.querySelector("#closeNotificationButton");
